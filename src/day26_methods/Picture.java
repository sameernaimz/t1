...
//    public static String draw(boolean isThere) {
//        System.out.println("Trying to draw");
//        return "";
//    }
...
//    }
    ...
    public static void draw (int num, String color) {
        ...
        System.out.println("Trying to draw with " + num + " color and " + color + " color ");
    ...
    public static void draw (int num) {
        ...
        System.out.println("Trying to draw with "  + num + " color ");
