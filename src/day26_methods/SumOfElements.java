...
public class SumOfElements {
    public static void main(String[] args) {
        ...
        System.out.println(contains(2, 34, 345, 654, 34, 23));
    ...
    //Create a method that accepts in array and sums up all the elements in the array and return the total
    // With the help of var-args
